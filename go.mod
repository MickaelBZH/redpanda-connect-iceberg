module github.com/redpanda-data/redpanda-connect-iceberg-output
...
// Use GitHub repository instead of published version
replace github.com/apache/iceberg-go => github.com/MickaelBZH/iceberg-go v0.0.0-20250806215230-1b0b288bae72

// Exclude v4 to force use of v3
exclude github.com/substrait-io/substrait-go/v4 v4.4.0
